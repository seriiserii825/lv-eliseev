            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-5">
                        <form method="POST"
                              action="{{ route('admin.adverts_attributes.update', [$attribute, 'category_id' => $category->id]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="variants" type="text"
                                          ...
                                          rows="7"
                                          name="variants">{{ old('variants', \App\Helpers\StringHelper::fromJson($attribute->variants)) }}</textarea>
                                @if ($errors->has('variants'))
                                    <span
                                        class="invalid-feedback"><strong>{{ $errors->first('variants', $attribute->variants) }}</strong></span>
                                @endif
                            </div>
